<div class="relative">
    ...
    @if ($typeInput == 'single')
        ...
        class="focus:ring-2 focus:ring-[var(--focus-color)] outline-none border-[var(--border-table-color)] text-[var(--contrast-main-text)] w-full border rounded-lg pl-10 py-2.5 transition-all">
