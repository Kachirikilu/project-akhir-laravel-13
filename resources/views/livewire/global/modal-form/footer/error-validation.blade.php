@if (($show ?? true) && $errors->any())
    <div
        ...
        <div class="flex items-center gap-2 mb-3">
            ...
            <h4 class="font-bold text-red-700 dark:text-red-400 text-xs text-sm  uppercase tracking-wider">
        ...
        <div class="space-y-2">
            @foreach ($errors->all() as $error)
                <div class="flex items-start gap-3">
                    ...
                    <p class="text-xs text-sm text-sm text-red-600 dark:text-red-300 leading-relaxed">
                        {{ $error }}
                    </p>
                </div>
            @endforeach
