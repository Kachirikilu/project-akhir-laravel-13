...
<flux:modal :flyout="$isFlyoutUser" name="user-modal" wire:model.live="showUserModal"
    ...
    {{-- @sync-user-store.window="$store.user.setValueUser(
        ...
        $event.detail.nip, $event.detail.nitk, $event.detail.nidn, $event.detail.nidk,
        $event.detail.nim, $event.detail.nik, $event.detail.angkatan, $event.detail.status,
        $event.detail.prId, $event.detail.kodePr, $event.detail.prodi, $event.detail.departemen,
        $event.detail.fakultas, $event.detail.wilayah, $event.detail.rps, $event.detail.sks,
        $event.detail.rekap, $event.detail.index, $event.detail.mutu, $event.detail.jk,
        $event.detail.agama, $event.detail.tmtLahir, $event.detail.tglLahir, $event.detail.noHP
    )" --}}
