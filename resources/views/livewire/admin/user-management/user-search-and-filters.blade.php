    ...
    <div class="table-border flex items-end justify-between border-b mb-4 gap-4">
        <div class="min-w-0 flex-1 overflow-hidden">
            @include('livewire.global.search-and-filters.filter-mode', [
                ...
                'totalTab' => $stats[($role ?? null ? $role : 'user') . '-prodi'] ?? null,
                'totalTab1' => $stats[($role ?? null ? $role : 'user') . '-opsi'] ?? null,
                'totalTab2' => $stats[($role ?? null ? $role : 'user') . '-aktif'] ?? null,
                'totalTab3' => $stats[($role ?? null ? $role : 'user') . '-non-aktif'] ?? null,
