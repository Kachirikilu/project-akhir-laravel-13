            ...
            @else
                <div class="w-full pb-1 flex flex-wrap items-center gap-2.5 w-full lg:w-auto lg:justify-end">
                    ...
                    @include('livewire.global.table.head-sortir', [
                        ...
                        'headString' => $switchTable == '' ? 'NIP/NIM' : 'NIP',
                    ])
                    @include('livewire.global.table.head-sortir', [
                        'sortFieldString' =>
                            $switchTable == '' ? 'identity2' : ($switchTable == 'admin' ? 'nitk' : 'nidn'),
                        'headString' => $switchTable == '' ? 'NITK/NIDN' : null,
                    ])
                    ...
                    <td class="table-second text-center">
                        <flux:dropdown>
                            <button class="cursor-pointer focus:outline-none"
                                wire:click="$dispatch('trigger-user-modal')">
