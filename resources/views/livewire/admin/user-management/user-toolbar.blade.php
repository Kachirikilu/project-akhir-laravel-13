<div class="flex flex-wrap items-center gap-2 mb-4">
    ...
    <div class="ml-auto">
        <flux:dropdown>
            <flux:button variant="primary" icon="plus" size="sm" wire:click="$dispatch('trigger-user-modal')"
            ...
            <flux:menu
                ...
                <flux:menu.item
                    @click="
                        ...
                        {{-- $wire.addUser('admin'); --}}
                        $dispatch('open-add-user-modal', { role: 'admin' });
                    "
                ...
                <flux:menu.item
                    @click="
                        ...
                        $store.user?.reset(1);
                        $flux.modal('user-modal').show();
                        $dispatch('open-add-user-modal', { role: 'dosen' });
                    "
                ...
                <flux:menu.item
                    @click="
                        ...
                        $store.user?.reset(1);
                        $flux.modal('user-modal').show();
                        $dispatch('open-add-user-modal', { role: 'mahasiswa' });
                    "
                ...
                <flux:menu.item
                    @click="
                        ...
                        {{-- $wire.addUser('excel'); --}}
                        $dispatch('open-excel-user-modal');
                    "
