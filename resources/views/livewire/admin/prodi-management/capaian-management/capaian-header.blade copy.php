    @php
        ...
        switch ($prodi_data['akreditas_pr']) {
            case 'A':
...
<div
    class="md:px-6 lg:px-8 xl:px-12 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-9 bg-[var(--second-pop-up-color)] p-6 rounded-xl border table-border shadow-sm">
    ...
    <div class="flex flex-col gap-1">
        ...
        <span class="text-md sm:text-lg font-semibold text-[var(--contrast-second-text)]">
            {{ $prodi_data['count_mk'] ?? 0 }} <span class="ml-2 text-xs sm:text-sm font-normal opacity-70">MK</span>
            <span class="mx-1 text-sm sm:text-md font-normal opacity-70">/</span>
            {{ $prodi_data['count_rps_aktif'] ?? 0 }} <span class="ml-2 text-xs sm:text-sm font-normal opacity-70">RPS</span>
        </span>
    ...
    <div class="flex flex-col gap-1">
        ...
        <span class="text-md sm:text-lg font-semibold text-[var(--contrast-second-text)]">
            {{ $prodi_data['index_pr'] }}<span class="text-xs sm:text-sm font-normal opacity-70"> / 4.00</span>
        </span>
        <span class="text-xs sm:text-sm text-[var(--contrast-main-text)] opacity-70">
