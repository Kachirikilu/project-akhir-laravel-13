            ...
            <td class="table-main-sticky text-center">
                <flux:dropdown>
                    ...
                    <flux:menu
                        ...
                        <livewire:admin.prodi-management.toolbar-prodi-management lazy :id="$x->id"
                            :dp_id="$x->dp_id ?? null" :fk_id="$x->fk_id ?? null" :strata="$x->strata ?? null" :kode="$x->kode ?? null" :kode_short="$x->kode_short ?? null" :kode_dp="$x->kode_dp ?? null"
                            :kode_fk="$x->kode_fk ?? null" :prodi="$x->prodi ?? null" :departemen="$x->departemen ?? null" :fakultas="$x->fakultas ?? null" :departemen_dp="$x->departemen_dp ?? null"
                            :fakultas_fk="$x->fakultas_fk ?? null" :switchTable="$switchTable" :isTrashed="$x->trashed()"
                            wire:key="toolbar-prodi-{{ $x->id }}-1" />
                    </flux:menu>
                ...
                <flux:dropdown>
                    ...
                    <flux:menu
                        ...
                        <livewire:admin.prodi-management.toolbar-prodi-management lazy :id="$x->id"
                            ...
                            :kode_fk="$x->kode_fk ?? null" :prodi="$x->prodi ?? null" :departemen="$x->departemen ?? null" :fakultas="$x->fakultas ?? null" :departemen_dp="$x->departemen_dp ?? null"
                            :fakultas_fk="$x->fakultas_fk ?? null" :switchTable="$switchTable" :isTrashed="$x->trashed()"
                            :isTrashed="$x->trashed()" wire:key="toolbar-prodi-{{ $x->id }}-2" />
                    </flux:menu>
                ...
                <td class="table-second table-border-l text-center">
                    <flux:dropdown>
                        ...
                        <flux:menu
                            class="!bg-[var(--second-pop-up-color)] !table-border !text-[var(--contrast-main-text)] text-xs sm:text-sm scrollbar-medium">
                            <livewire:admin.prodi-management.toolbar-prodi-management lazy :id="$x->id"
                                :dp_id="$x->dp_id ?? null" :fk_id="$x->fk_id ?? null" :strata="$x->strata ?? null" :kode="$x->kode" :kode_short="$x->kode_short ?? null"
                                :kode_dp="$x->kode_dp ?? null" :kode_fk="$x->kode_fk ?? null" :prodi="$x->prodi ?? null" :departemen="$x->departemen ?? null"
                                :fakultas="$x->fakultas ?? null" :departemen_dp="$x->departemen_dp ?? null" :fakultas_fk="$x->fakultas_fk ?? null" :switchTable="$switchTable"
                                :isTrashed="$x->trashed()" wire:key="toolbar-prodi-{{ $x->id }}-3" />
                        </flux:menu>
                ...
                <flux:dropdown>
                    ...
                    <flux:menu
                        ...
                        <livewire:admin.prodi-management.toolbar-prodi-management lazy :id="$x->id"
                            ...
                            :kode_fk="$x->kode_fk ?? null" :prodi="$x->prodi ?? null" :departemen="$x->departemen ?? null" :fakultas="$x->fakultas ?? null" :departemen_dp="$x->departemen_dp ?? null"
                            :fakultas_fk="$x->fakultas_fk ?? null" :switchTable="$switchTable" :isTrashed="$x->trashed()"
                            :isTrashed="$x->trashed()" wire:key="toolbar-prodi-{{ $x->id }}-4" />
                    </flux:menu>
