<flux:modal name="prodi-delete" wire:model.live="showProdiDelete" class="min-w-[20rem] max-w-md !bg-[var(--second-pop-up-color)] !table-border !text-[var(--contrast-main-text)] text-xs sm:text-sm">
