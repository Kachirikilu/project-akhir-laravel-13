<div>
    <flux:modal name="jadwal-delete" wire:model.live="showJadwalDelete"
        ...
        @if ($isReady)
            <div class="space-y-6">
                ...
                transition-colors duration-200">
                    ...
                    <flux:button wire:click="destroyJadwal" wire:loading.attr="disabled"
                        wire:target="deleteJadwal, destroyJadwal" type="submit" variant="primary"
