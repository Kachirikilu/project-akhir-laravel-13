...
@php
    ...
    foreach ($groupsCpmk as $kodeCpmk => $pertemuans) {
        ...
        $rataKeberhasilanCpmk[$kodeCpmk] = $totalMahasiswa > 0 
            ? round(array_sum($semuaNilaiCpmk) / $totalMahasiswa, 1) 
            : 0;
    }
        ...
        <div class="page-container w-full" style="height: 10vh;">
            ...
            <div class="pt-6">
                ...
                <div class="relative" style="height: 320px; padding-top: 68px;">
                    ...
                    <div class="absolute top-0 right-0 flex items-center gap-6 bg-gray-50 dark:bg-zinc-950/50 px-4 py-2 rounded-lg border border-gray-100 dark:border-zinc-800 z-30">
