<style>
    ...
    *::after {
    ...
    .cpmk-legend-item {
        ...
        vertical-align: top;
        text-align: left;
        /* Supaya teks di dalam item tetap rata kiri */
        margin-left: 20px;
        /* Jarak antar item */
        margin-bottom: 10px;
        /* Jarak antar baris */
...
@yield('content')
<div class="nilai-pdf bg-white" style="padding: 12px 24px;">
    @php
            ...
            <div class="page-container w-full" style="height: 10vh;">
                ...
                <div class="chart-body">
                    ...
                    <div class="relative" style="height: 360px; padding-top: 68px;">
                            ...
                            @foreach ($daftarCpmk as $index => $kodeCpmk)
                                <div class="cpmk-legend-item">
                                    <table class="cpmk-legend-table">
                                        <tr>
                                            <td class="cpmk-legend-swatch-cell" style="padding-right: 6px;">
                                            ...
                                            <td>
                                                ...
                                                <p class="text-gray-500 font-medium leading-none cpmk-legend-detail"
                        ...
                        <table class="chart-outer-table" style="transform: translateY(98px);">
                            <tr>
                                {{-- Kolom sumbu-Y --}}
                                ...
                                <td class="chart-area-cell">
                                    ...
                                    <div class="relative chart-area-frame" style="height: 252px;">
                                        ...
                                        {{-- Bar per mahasiswa --}}
                                        <table class="chart-bars-table" style="transform: translateY(-19px);">
                                            <tr>
                                                        ...
                                                        <table class="chart-bar-inner-table">
                                                            ...
                                                            <tr>
                                                                @foreach ($finalSeries as $idxSeries => $series)
                                                                    ...
                                                                    @endphp
                                                                    <td style="height: 252px; vertical-align: bottom;">
                                                                        <span
                                                                            class="font-bold leading-none whitespace-nowrap chart-bar-value"
                                                                            style="color: {{ $color }};">
                                                                            {{ $value }}
                                                                        </span>
