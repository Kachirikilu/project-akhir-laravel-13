                ...
                <div wire:key="kelas-sesi-card-{{ $s->id }}" x-data="{
                    ...
                    @php
                        if ($isUjian) {
                            ...
                            $borderTable = 'border-[var(--border-table-color-special)] bg-[var(--second-table-color-special)]';
                            ...
                            $borderTable = 'border-[var(--border-table-color)] bg-[var(--second-table-color)]';
