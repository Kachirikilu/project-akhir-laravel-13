<x-global.main-layout-card :paginator="$sesis">
    ...
    <div x-data="{
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
            ...
            @empty
                <div
                    ...
                    <p class="text-xs sm:text-sm text-[var(--contrast-second-text)]">Tidak ada data Sesi Pertemuan Kelas ditemukan!
                    </p>
                </div>
            @endforelse
        </div>
        ...
        <div x-show="totalFilteredItems > perPage"
            class="flex items-center justify-between pt-4 border-t table-border">
