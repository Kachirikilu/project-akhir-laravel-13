        ...
        <div class="w-full md:w-96 xl:w-108">
            <div class="col-start-1 row-start-1 w-full">
                ...
                <div class="relative w-full max-w-md">
                    <input x-data x-model="$store.sesi.search" type="search"
    ...
    <div x-data="{
        ...
        get visibleCards() {
            return Array.from(document.querySelectorAll('.card-sesi-item')).filter(el => {
                return el.__x_data_stack && el.__x_data_stack[0] && el.__x_data_stack[0].matchSearchPassed;
            });
        },
        ...
        get totalFilteredItems() {
            ...
            if (count === 0) {
                let totalCards = document.querySelectorAll('.card-sesi-item').length;
                if (($store.sesi?.search || '').trim() !== '') return 0;
                return totalCards;
            }
            return count;
        },
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
            @forelse($sesis as $index => $s)
                ...
                }" {{-- Kondisi Tampil: Lolos filter DAN berada di halaman aktif --}}
                        ...
                        @if (!$isUjian)
                            <div
                                ...
                                <div
                                    ...
                                    <span
                                        x-text="expanded ? 'Klik untuk merapatkan' : 'Klik kartu untuk detail'"></span>
        ...
        <div x-show="totalFilteredItems > perPage"
            class="flex items-center justify-between pt-4 border-t border-[var(--border-table-color)]">
            <div class="text-xs text-[var(--contrast-second-text)]">
                ...
                dari <span class="font-semibold text-[var(--contrast-main-text)]" x-text="totalFilteredItems"></span>
                data sesi
            </div>
            ...
            <div class="flex items-center gap-1">
                ...
                <div class="flex items-center gap-1 mx-2 text-xs text-[var(--contrast-second-text)]">
                    Halaman <span class="font-semibold text-[var(--contrast-main-text)]" x-text="currentPage"></span>
                    dari <span class="font-semibold text-[var(--contrast-main-text)]" x-text="totalPages"></span>
                </div>
                <button type="button"
