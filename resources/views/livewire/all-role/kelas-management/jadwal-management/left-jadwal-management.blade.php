<div>
    <flux:modal name="left-jadwal-modal" wire:model.live="showJadwalLeft" wire:key="left-jadwal-modal" x-data
        @refresh-data-jadwal.window="$store.jadwal?.reset()"
        ...
        @if ($isReady)
            <div class="space-y-6">
                ...
                transition-colors duration-200">
                    ...
                    <flux:button wire:click="leftJadwal" wire:loading.attr="disabled"
                        wire:target="deleteRPS, leftJadwal" type="submit" variant="primary"
