    ...
    <x-global.main-layout-card :paginator="$jadwals" :mx="''">
                    ...
                    <div class="grid grid-cols-2 gap-1.5">
                        ...
                        <div
                            ...
                            @if ($j->is_my_class)
                                ...
                                <span class="text-[10px] font-semibold text-[var(--contrast-main-text)]">Kelas
                                    Saya</span>
                    ...
                    @if ($j->is_my_class || Auth::user()->admin || Auth::user()->dosen)
                        <button
                            ...
                            <flux:icon name="calendar-days"
                                class="w-3.5 h-3.5 {{ $j->trashed() ? 'opacity-40' : '' }}" />
        ...
        @empty
            ...
            <div
                ...
                <p class="text-xs sm:text-sm text-[var(--contrast-second-text)]">Tidak ada data Jadwal Kelas
                    {{ $switchTable == 'hari-ini' ? 'hari ini' : '' }} ditemukan!</p>
            </div>
        @endforelse
