<div wire:key="view-table-mahasiswa-nilai">
    ...
    <x-global.main-layout-table :paginator="$users" :onlyAdmin="!Auth::user()->admin">
        ...
        <x-slot:header>
            <tr>
                ...
                <th colspan="{{ $showMore ? 4 : 3 }}" class="table-head-sub">
                    Nilai Capaian
                </th>
                ...
                @else
                    <th rowspan="2" class="table-head border-x">
                        RPS
                    </th>
                @endif
        ...
        @forelse($users as $user)
            <tr wire:key="mahasiswa-nilai-{{ $user->mahasiswa->id }}"
                data-mahasiswa-nilai-id="{{ $user->mahasiswa->id }}"
                ...
                @if ($showMore)
                    ...
                    <td class="table-sub table-border-r text-center">
                        {{ $user->mahasiswa->total_sks ?? $user->total_sks }}
                        SKS</td>
                @endif
