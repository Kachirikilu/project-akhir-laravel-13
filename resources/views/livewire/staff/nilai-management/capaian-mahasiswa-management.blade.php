<div x-data="{ activeTable: '{{ $switchTable ?? '' }}' }"
    ...
    @navigate.window="
        ...
        activeTable = (segment === 'capaian-mahasiswa-management' || segment === '') ? '' : segment;
     "
    class="py-6 sm:px-6 sm:py-10 sm:bg-[var(--wadah-color)] sm:shadow-sm rounded-xl">

    @include('livewire.global.header.tag-user')

    @include('livewire.staff.nilai-management.capaian-mahasiswa-management.capaian-mahasiswa-header')
