<div>
    <flux:modal name="rps-mahasiswa-delete" wire:model.live="showRPSMahasiswaDelete"
        ...
        @if ($isReady)
            <div class="space-y-6">
                ...
                <div class="flex gap-2">
                    ...
                    <flux:button wire:click="destroyNilai" wire:loading.attr="disabled"
                        wire:target="deleteNilai, destroyNilai" type="submit" variant="primary"
