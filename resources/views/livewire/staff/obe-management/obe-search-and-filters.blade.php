        ...
        <div x-show="activeTab == 'referensi'" x-transition:enter="transition ease-out duration-1000"
            ...
            <div class="min-w-0 flex-1 overflow-hidden">
                @include('livewire.global.search-and-filters.filter-mode', [
                    ...
                    'totalTab' => $stats['ref'] ?? null,
                    'totalTab1' => $stats['ref-year'] ?? null,
                    'totalTab2' => $stats['ref-2-3-years'] ?? null,
                    'totalTab3' => $stats['ref-4-5-years'] ?? null,
                    'totalTab4' => $stats['ref-6-10-years'] ?? null,
                    'totalTab5' => $stats['ref-older-10'] ?? null,
                    'tab1String' => 'ref-year',
            ...
            <div class="min-w-0 flex-1 overflow-hidden">
                @if (Auth::user()->dosen)
                    @include('livewire.global.search-and-filters.filter-mode', [
                        ...
                        'totalTab' => $stats['tim-dosen-saya'] ?? null,
                        'totalTab1' => $stats['tim-dosen-prodi'] ?? null,
                        'totalTab2' => $stats['tim-dosen-all'] ?? null,
                        'totalTab3' => $stats['tim-dosen-rps'] ?? null,
                        'totalTab4' => $stats['tim-dosen-non-rps'] ?? null,
                ...
                @else
                    @include('livewire.global.search-and-filters.filter-mode', [
                        'filterByFunc' => 'filterByTimDosen',
                        'filterString' => 'filterTimDosen',
                        'totalTab' => $stats['tim-dosen-prodi'] ?? null,
                        'totalTab1' => $stats['tim-dosen-all'] ?? null,
                        'totalTab2' => $stats['tim-dosen-rps'] ?? null,
                        'totalTab3' => $stats['tim-dosen-non-rps'] ?? null,
        ...
        <div x-show="activeTab == 'dosen'" x-transition:enter="transition ease-out duration-1000"
            ...
            <div class="col-span-2 lg:col-span-1 min-w-0 overflow-hidden table-border sm:border-b">
                @include('livewire.global.search-and-filters.filter-mode', [
                    ...
                    'totalTab' => $stats['dosen'] ?? null,
                    'totalTab1' => $stats['dosen-rps'] ?? null,
                    'totalTab2' => $stats['dosen-non-rps'] ?? null,
            ...
            {{-- filter-mode 2 --}}
            <div class="min-w-0 overflow-hidden sm:mt-2 lg:mt-0">
                @include('livewire.global.search-and-filters.filter-mode', [
                    'filterByFunc' => 'filterByStatus',
                    'filterString' => 'filterStatus',
                    'totalTab' => $stats['dosen-prodi'] ?? null,
                    'totalTab1' => $stats['dosen-all'] ?? null,
                    'totalTab2' => $stats['dosen-aktif'] ?? null,
                    'totalTab3' => $stats['dosen-non-aktif'] ?? null,
