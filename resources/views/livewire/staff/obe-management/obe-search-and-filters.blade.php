<div x-data="{ activeTab: @entangle('switchTable'), activeFilterDosen: @entangle('filterStatus') }"
    ...
    <div x-show="activeTab !== 'rps'"
        x-bind:class="activeTab !== 'referensi' ? 'row-start-2 col-start-1' : 'row-start-1 col-start-2'"
    ...
    <div x-show="activeTab == 'cpmk'"
        x-bind:class="activeTab !== 'referensi' ? 'sm:col-span-3 row-start-2 col-start-2' : 'sm:col-span-4 row-start-2 col-start-1'"
    ...
    <div x-show="activeTab == 'sub-cpmk' || activeTab == 'cpl' || activeTab == 'ref'"
        x-bind:class="activeTab !== 'referensi' ? 'sm:col-span-4' : 'sm:col-span-3'"
