    ...
    <flux:modal name="scpmk-modal" wire:model="showSCPMKModal" x-data :flyout="!!$parent"
        ...
        <div class="flex flex-col h-full relative">
            ...
            <div class="md:px-4 lg:px-6 py-6 pb-4 border-b border-[var(--contrast-second-text)]">
                ...
                <h3 class="text-xl font-semibold">
                    ...
                    <flux:badge icon="academic-cap" color="fuchsia" size="lg">
                        <span x-text="$store.scpmk?.isEdit ? 'Edit OBE - Sub-CPMK' : 'Tambah OBE - Sub-CPMK'"></span>
                    </flux:badge>
            ...
            <div class="flex-1 overflow-y-auto sm:p-6 py-6 scrollbar-large">
                <form
                    x-on:submit.prevent="$store.scpmk.isEdit ? $wire.updateSCPMK($store.scpmk) : $wire.saveSCPMK($store.scpmk)"
