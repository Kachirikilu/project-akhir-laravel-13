<flux:modal name="tim-dosen-delete" wire:model.live="showTimDosenDelete"
    ...
    <div class="space-y-6">
        ...
        <div class="flex gap-2">
            ...
            <flux:button wire:click="destroyTimDosen" wire:loading.attr="disabled" wire:target="deleteTimDosen, destroyTimDosen"
