<div class="flex flex-col h-full relative">
    ...
    <div class="md:px-4 lg:px-6 py-6 pb-4 border-b border-[var(--contrast-second-text)]">
        ...
        <h3 class="text-xl font-semibold">
            ...
            <flux:badge icon="clipboard-document-list" color="blue" size="lg">
                <span x-text="$store.tim_dosen?.isEdit ? 'Edit OBE - Tim Dosen' : 'Tambah OBE - Tim Dosen'"></span>
            </flux:badge>
    ...
    <div class="flex-1 overflow-y-auto sm:p-6 py-6 scrollbar-large">
        <form
            x-on:submit.prevent="$store.tim_dosen.isEdit ? $wire.updateTimDosen($store.tim_dosen) : $wire.saveTimDosen($store.tim_dosen)"
