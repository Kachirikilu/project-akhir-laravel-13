    ...
    <div class="min-w-0 flex-1 overflow-hidden">
        @if (Auth::user()->dosen)
            @include('livewire.global.search-and-filters.filter-mode', [
                ...
                'totalTab2' => $stats['rps-prodi-non-aktif'],
                'totalTab3' => $stats['rps'],
                'totalTab4' => $stats['rps-akademik'],
                'totalTab5' => $stats['rps-rev-new'],
                'totalTab6' => $stats['rps-aktif'],
                'totalTab7' => $stats['rps-draf'],
                'totalTab8' => $stats['rps-older-5'],
        ...
        @else
            @include('livewire.global.search-and-filters.filter-mode', [
                ...
                'totalTab1' => $stats['rps-prodi-non-aktif'],
                'totalTab2' => $stats['rps'],
