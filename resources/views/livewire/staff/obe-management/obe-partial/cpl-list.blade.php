            ...
            <template x-for="(cpl, index) in $store.rps.cpl_cpmk" :key="cpl.id">
                <div
                    ...
                    <div class="p-3 flex items-start gap-3 border-l-4 border-l-emerald-600">
                        <div class="flex flex-col items-center leading-none" style="width: 16px;">
                            <template x-for="digit in (index + 1).toString().split('')">
                                <span class="text-xs font-black text-emerald-600 dark:text-emerald-400" x-text="digit">
                                </span>
                            </template>
                        </div>
                        <div class="flex flex-col gap-1 flex-1 min-w-0">
                            <div class="flex items-center gap-2">
                                <span
                                    class="text-xs font-bold px-1.5 py-0.5 rounded bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400"
                            ...
                            <p class="text-xs text-[var(--contrast-main-text)] leading-relaxed" x-text="cpl.deskripsi">
                            </p>
                        </div>
                    </div>
                </div>
