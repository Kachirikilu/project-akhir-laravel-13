                ...
                <flux:menu
                    ...
                    <flux:menu.item
                        @click="
                            ...
                            $dispatch('open-add-mk-modal', { tingkatan: 1 });
                        "
                    ...
                    @if (Auth::user()->tingkat < 4)
                        ...
                        <flux:menu.item
                            ...
                            $store.mk?.reset(1);
                            $flux.modal('mk-modal').show();
                            $dispatch('open-add-mk-modal', { tingkatan: 2 });
                        "
                        ...
                        @if (Auth::user()->tingkat < 3)
                            ...
                            $store.mk?.reset(1);
                            $flux.modal('mk-modal').show();
                            $dispatch('open-add-mk-modal', { tingkatan: 3 });
                        "
                            ...
                            $store.mk?.reset(1);
                            $flux.modal('mk-modal').show();
                            $dispatch('open-add-mk-modal', { tingkatan: 4 });
                        "
