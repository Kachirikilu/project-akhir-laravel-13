    ...
    <x-global.main-layout-card :paginator="$periodes">
            ...
            <div wire:key="periode-{{ $p->akademik }}-{{ $p->ganjil_genap }}"
                ...
                <div class="flex-1 py-4 flex flex-col justify-center">
                    ...
                    <p class="text-xs font-medium text-[var(--contrast-third-text)] mt-2 flex items-center gap-1.5">
                        ...
                        Total Beban: <strong class="text-[var(--contrast-main-text)]">{{ $p->total_sks ?? 0 }}
                            SKS</strong>
                    </p>
                </div>
                <div
        ...
        @empty
            ...
            <div
                ...
                <p class="text-xs sm:text-sm text-[var(--contrast-second-text)]">Tidak ada riwayat indeks prestasi
                    semester ditemukan!
                </p>
            </div>
        @endforelse
