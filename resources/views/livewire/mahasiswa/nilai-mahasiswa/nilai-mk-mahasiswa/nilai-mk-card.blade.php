<x-global.main-layout-card :paginator="$detailNilaiRps">
    ...
    @forelse($detailNilaiRps as $n)
        <div wire:key="nilai-rps-{{ $n->id }}"
            ...
            <div class="pt-3 border-t border-[var(--border-table-color)]/40 -mx-5 -mb-5 p-4 bg-[var(--second-table-trans)] rounded-b-xl flex items-center justify-between">
    ...
    @empty
        ...
        <div class="col-span-full text-center p-12 rounded-xl border border-dashed border border-[var(--border-table-color)] bg-[var(--main-table-trans)]">
