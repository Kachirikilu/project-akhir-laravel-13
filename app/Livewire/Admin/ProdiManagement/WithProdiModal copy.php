    ...
    public function editProdi($id, $type)
    {
        ...
        try {
            if ($type === 'prodi') {
                ...
                $this->prodi_input['kode_pr'] = $prodi->kode_pr;
                $this->prodi_input['nama_pr'] = $prodi->prodi;
                $this->prodi_input['strata'] = $prodi->strata;
                ...
                $this->prodi_input['kode_dp'] = $departemen->kode_dp;
                $this->prodi_input['nama_dp'] = $departemen->departemen;
                ...
                $this->prodi_input['kode_fk'] = $fakultas->kode_fk;
                $this->prodi_input['nama_fk'] = $fakultas->fakultas;
            }
